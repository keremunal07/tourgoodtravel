...
function ruTranslate() {
    doGTranslate('auto|ru')
    document.getElementById("language").src = "img/language/ru/russian.png"
}
function enTranslate() {
    doGTranslate('auto|en')
    document.getElementById("language").src = "img/language/en/english.png"
}
function trTranslate() {
    doGTranslate('auto|tr')
    document.getElementById("language").src = "img/language/tr/turkish.png"
}
function arTranslate() {
    doGTranslate('auto|ar')
    document.getElementById("language").src = "img/language/ar/arabic.png"
}